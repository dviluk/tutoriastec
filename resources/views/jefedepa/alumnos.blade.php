    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="{{URL::to('jefedepa/alumnos')}}"><i class="fa fa-graduation-cap fa-fw"></i> Alumnos</a>
                </li>
                <li>
                    <a href="{{URL::to('jefedepa/docentes')}}"><i class="fa fa-user fa-fw"></i> Docentes</a>
                </li>
                <li>
                    <a href="{{URL::to('jefedepa/horarios')}}"><i class="fa fa-clock-o fa-fw"></i> Horarios</a>
                </li>
                <li>
                    <a href="{{URL::to('jefedepa/periodos')}}"><i class="fa fa-calendar-o fa-fw"></i> Periodos</a>
                </li>
                <li>
                    <a href="{{URL::to('jefedepa/asesorias')}}"><i class="fa fa-plus-circle fa-fw"></i> Asesorias</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form">
                        <div class="form-group">
                            <input class="form-control" placeholder="Nombre del Alumno" type="text" id="Nombre"
                                   required>
                        </div>
                        <div class="form-group">
                            <label for="Carrera">Carreras:</label>
